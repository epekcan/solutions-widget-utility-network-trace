...
define([
  ...
  mo.load = function()
  {
      ...
      return new Promise (lang.hitch(this, function (resolve, reject)
      {
          ...
          if (thisObj.featureServiceJson.controllerDatasetLayers != undefined)
          {
              ...
              thisObj.traceControls.push(thisObj.getLineLayers());
              resolve(thisObj);
          }
          else
  ...
  mo.getLayer = function(utilityNetworkUsageType) {
    ...
    mo.getAssetGroups = function(utilityNetworkUsageType, network) {
    ...
    mo.getAGByDevice = function(param) {
        return this.getAssetGroups("esriUNFCUTDevice", param);
    };

    mo.getAGByLine = function() {
        return this.getAssetGroups("esriUNFCUTLine");
    };

    mo.getAGByJunction = function() {
        return this.getAssetGroups("esriUNFCUTJunction");
    };
  ...
  mo.isLayerEdge = function(layerId) {
    ...
    mo.getDeviceInfo = async function() {
        ...
        let queryDataElementUrl = this.featureServiceUrl + "/queryDataElements";
        let layers = [layerId];
