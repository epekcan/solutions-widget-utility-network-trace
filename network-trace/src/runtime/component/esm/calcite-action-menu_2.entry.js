import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-cbdbef9d.js';
...
import { d as defaultOffsetDistance, u as updatePopper, c as createPopper, C as CSS$2 } from './popper-8707be6e.js';
import { g as getRoundRobinIndex } from './array-e627ad50.js';
import { T as TEXT$1, A as ARIA_EXPANDED, P as POPOVER_REFERENCE, a as ARIA_CONTROLS, C as CSS$1 } from './resources-f3ad7abe.js';
...
const CalcitePopover = class {
  ...
  renderCloseButton() {
    ...
    return closeButton ? (h("button", { "aria-label": intlClose, class: { [CSS$1.closeButton]: true }, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), title: intlClose }, h("calcite-icon", { icon: "x", scale: "m" }))) : null;
  }
  render() {
    ...
    return (h(Host, { "aria-hidden": hidden.toString(), "aria-label": label, "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { class: {
      ...
      } }, arrowNode, h("div", { class: CSS$1.container }, this.renderImage(), h("div", { class: CSS$1.content }, h("slot", null), this.renderCloseButton())))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
export { CalciteActionMenu as calcite_action_menu, CalcitePopover as calcite_popover };
