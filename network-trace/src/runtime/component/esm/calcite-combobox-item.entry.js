...
const CalciteComboboxItem = class {
  ...
  renderIcon(scale) {
    ...
    return h("calcite-icon", { class: CSS.icon, icon: iconPath, scale: iconScale });
  }
  renderChildren() {
  ...
  render() {
    ...
    return (h(Host, { "aria-selected": this.isSelected.toString(), dir: dir, disabled: this.disabled, role: "option", scale: scale, tabIndex: this.disabled ? null : 0 }, h("div", { class: classes, onClick: this.itemClickHandler, ref: (el) => (this.comboboxItemEl = el) }, this.renderIcon(scale), h("span", { class: CSS.title }, this.textLabel)), this.renderChildren()));
  }
