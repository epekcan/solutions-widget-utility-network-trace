import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-cbdbef9d.js';
...
const CalciteShellPanel = class {
  ...
  render() {
    ...
    const contentNode = (h("div", { class: { [CSS.content]: true, [CSS.contentDetached]: detached }, hidden: collapsed }, hasHeader ? h("slot", { name: SLOTS.header }) : null, h("slot", null)));
