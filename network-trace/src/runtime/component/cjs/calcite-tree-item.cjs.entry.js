...
const CalciteTreeItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-expanded": this.hasChildren ? this.expanded.toString() : undefined, "aria-hidden": this.parentExpanded || this.depth === 1 ? undefined : "true", "aria-selected": this.selected
        ? "true"
        : this.selectionMode === TreeSelectionMode.TreeSelectionMode.Multi ||
          ...
          ? "false"
          : undefined, role: "treeitem", tabindex: this.parentExpanded || this.depth === 1 ? "0" : "-1" }, index.h("div", { class: "calcite-tree-node", ref: (el) => (this.defaultSlotWrapper = el) }, icon, index.h("slot", null)), index.h("div", { class: "calcite-tree-children", "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, ref: (el) => (this.childrenSlotWrapper = el), role: this.hasChildren ? "group" : undefined }, index.h("slot", { name: "children" }))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
