...
const CalciteLink = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { dir: dir }, index.h(Tag, Object.assign({}, attributes, { href: Tag === "a" && this.href, ref: (el) => (this.childEl = el), role: role, tabIndex: tabIndex }), this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
