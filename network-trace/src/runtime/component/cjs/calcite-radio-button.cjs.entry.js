...
const CalciteRadioButton = class {
  ...
  renderLabel() {
    ...
    if (this.el.textContent) {
      ...
      this.label.setAttribute("dir", dom.getElementDir(this.el));
  ...
  render() {
    return (index.h(index.Host, { "aria-checked": this.checked.toString(), "aria-disabled": this.disabled.toString(), labeled: this.el.textContent ? true : false }, index.h("div", { class: "radio" }), index.h("slot", null)));
  }
