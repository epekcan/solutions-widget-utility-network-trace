...
const StatusIcons = require('./StatusIcons-a7dbdd3b.js');
...
const CalciteAlert = class {
  ...
  updateRequestedIcon() {
    this.requestedIcon = dom.setRequestedIcon(StatusIcons.StatusIcons, this.icon, this.color);
  }
  //--------------------------------------------------------------------------
  //
  //  Lifecycle
