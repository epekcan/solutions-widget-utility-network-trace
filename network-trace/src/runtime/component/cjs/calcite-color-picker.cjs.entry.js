...
const CalciteColorPicker = class {
  ...
  render() {
    ...
    return (index.h("div", { class: resources.CSS.container }, index.h("canvas", { class: {
      ...
      } }, intlHex), index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: resources.CSS.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [resources.CSS.colorModeContainer]: true,
        [resources.CSS.splitSection]: true
      }, dir: elementDir }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [resources.CSS.savedColorsSection]: true, [resources.CSS.section]: true } }, index.h("div", { class: resources.CSS.header }, index.h("label", null, intlSaved), index.h("div", { class: resources.CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: resources.CSS.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), index.h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: resources.CSS.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (index.h("div", { class: resources.CSS.savedColors }, [
      ...savedColors.map((color) => (index.h("calcite-color-picker-swatch", { active: selectedColorInHex === color, class: resources.CSS.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })))
    ])) : null))));
  }
  // --------------------------------------------------------------------------
  //
