...
const focusable = require('@a11y/focus-trap/focusable');
const shadow = require('@a11y/focus-trap/shadow');
...
const CalciteModal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-modal": "true", dir: dir, "is-active": this.isActive, role: "dialog" }, index.h("calcite-scrim", { class: "scrim", theme: "dark" }), this.renderStyle(), index.h("div", { class: "modal" }, index.h("div", { "data-focus-fence": "true", onFocus: this.focusLastElement.bind(this), tabindex: "0" }), index.h("div", { class: "modal__header" }, this.renderCloseButton(), index.h("header", { class: "modal__title" }, index.h("slot", { name: "header" }))), index.h("div", { class: {
        modal__content: true,
        "modal__content--spaced": !this.noPadding
      }, ref: (el) => (this.modalContent = el) }, index.h("slot", { name: "content" })), this.renderFooter(), index.h("div", { "data-focus-fence": "true", onFocus: this.focusFirstElement.bind(this), tabindex: "0" }))));
  }
  renderFooter() {
  ...
  async focusElement(el) {
    ...
    const focusableElements = shadow.queryShadowRoot(this.el, focusable.isHidden, focusable.isFocusable);
  ...
  focusLastElement() {
    var _a;
    const focusableElements = shadow.queryShadowRoot(this.el, focusable.isHidden, focusable.isFocusable).filter((el) => !el.getAttribute("data-focus-fence"));
    if (focusableElements.length > 0) {
