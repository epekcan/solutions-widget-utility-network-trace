...
const CalciteInputMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { dir: dir, theme: this.theme }, this.icon ? this.renderIcon(this.iconDefaults[this.status]) : null, index.h("slot", null)));
  }
  //--------------------------------------------------------------------------
  //
  //  Private Methods
